...
NINETY_DEGREES = 55 # number of iterations to turn 90 degrees for BASE_SPEED 100 dt = 0.1
MARGIN = 1

@dataclass
class LocalNav:
    turn_direction: str          # e.g. "left", "right", "none"
    state_local_nav: str         # e.g. "idle", "turning", "advancing"
